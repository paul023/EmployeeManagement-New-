    ...
    public partial class leave : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveApps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeaveApps_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveApps_LeaveTypes_LeaveTypeId",
                        column: x => x.LeaveTypeId,
                        principalTable: "LeaveTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveApps_SystemCodeDetails_DurationId",
                        column: x => x.DurationId,
                        principalTable: "SystemCodeDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveApps_SystemCodeDetails_StatusId",
                        column: x => x.StatusId,
                        principalTable: "SystemCodeDetails",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveApps_DurationId",
                table: "LeaveApps",
                column: "DurationId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApps_EmployeeId",
                table: "LeaveApps",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApps_LeaveTypeId",
                table: "LeaveApps",
                column: "LeaveTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApps_StatusId",
                table: "LeaveApps",
                column: "StatusId");
