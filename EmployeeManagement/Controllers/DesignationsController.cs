...
namespace EmployeeManagement.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,code,name,CreateById,CreatedOn,ModifiedById,ModifiedOn")] Designation designation)
        {
