...
namespace EmployeeManagement.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,code,Description,CreateById,CreatedOn,ModifiedById,ModifiedOn")] SystemCode systemCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,code,Description,CreateById,CreatedOn,ModifiedById,ModifiedOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
