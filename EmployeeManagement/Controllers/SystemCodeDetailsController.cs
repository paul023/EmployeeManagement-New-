...
namespace EmployeeManagement.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SystemCodeId,Code,Description,OrderNo,CreateById,CreatedOn,ModifiedById,ModifiedOn")] SystemCodeDetail systemCodeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SystemCodeId,Code,Description,OrderNo,CreateById,CreatedOn,ModifiedById,ModifiedOn")] SystemCodeDetail systemCodeDetail)
        {
